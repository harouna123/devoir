  ...
  <form  method="POST" action="{{route('caisse.store')}}" >
    @csrf
        ...
        <div class="mb-3">
          ...
          <input type="text" name="nom_caisse" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
          <label for="exampleInputEmail1" class="form-label">prenom_caisse:</label>
          <input type="text" name="prenom_caisse" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
